...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='homepage',
            name='hero',
            field=wagtail.core.fields.StreamField([('hero', wagtail.core.blocks.StructBlock([('title', wagtail.core.blocks.CharBlock()), ('title_tag', wagtail.core.blocks.ChoiceBlock(choices=[('h1', 'h1'), ('p', 'p'), ('h2', 'h2'), ('h3', 'h3'), ('h4', 'h4'), ('h5', 'h5'), ('h6', 'h6')])), ('subtitle', wagtail.core.blocks.TextBlock(required=False)), ('hero_class', wagtail.core.blocks.CharBlock(required=False)), ('cta_text', wagtail.core.blocks.CharBlock(required=False)), ('cta_href', wagtail.core.blocks.CharBlock(default='#', required=False)), ('background_image', wagtail.images.blocks.ImageChooserBlock(required=False))]))], blank=True, null=True),
        ),
    ]
